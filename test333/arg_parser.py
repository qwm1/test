...
def parse_args():
    ...
    parser.add_argument('--optimizer', default='Adam', help='optimizer(SGD|Adam|AMSGrad)')
    ...
    parser.add_argument('--dataset', default='wisdm', help='dataset(cifar10|cifar100|svhn|stl10|mnist)')
