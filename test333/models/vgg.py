...
class VGG(nn.Module):
    def __init__(self, vgg_name,num_classes=6, deconv=None,delinear=None,channel_deconv=None):
        ...
        if delinear:
            self.classifier = delinear(26112, num_classes)
        else:
            self.classifier = nn.Linear(26112 ,num_classes)
